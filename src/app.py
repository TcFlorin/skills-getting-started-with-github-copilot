...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice and water safety training for all levels",
        "schedule": "Mondays, Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["emma@mergington.edu", "ava@mergington.edu"]
    },
    "Art Workshop": {
    ...
    "Drama Club": {
        "description": "Prepare for school plays, improvisation, and performance skills",
    ...
    "Science Olympiad": {
        "description": "Compete in science challenges and build STEM skills",
